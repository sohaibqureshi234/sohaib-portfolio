...
PORTFOLIO_DATA = {
    ...
    "stats": [
        ...
        {"number": "7", "label": "Production Applications"},
    ...
    "about": [
        ...
        "I adapt architecture and state management to the product and its existing codebase. My hands-on experience spans BLoC, GetX, Provider, and Riverpod, supported by code reviews, technical guidance, release preparation, CI/CD workflows, and App Store and Google Play deployment.",
        "My recent work includes healthcare workflows, Flutter Web, native Kotlin and Swift integrations, AI-powered LLM, OCR, and speech-to-text features, BLE and MQTT device communication, and Android TV optimization.",
    ],
    "details": [
    ...
    "skills": {
        ...
        "APIs & Firebase": ["REST APIs", "GraphQL", "WebSockets", "Firebase", "Firestore", "FCM", "Firebase Crashlytics", "OneSignal"],
        ...
        "Quality & Delivery": ["Unit Testing", "Widget Testing", "Integration Testing", "Git", "CI/CD", "Fastlane", "GitHub Actions", "App Store / Google Play"],
    },
    "experience": [
        {
